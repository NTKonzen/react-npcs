...
module.exports = function (io, { NPCObj, messageFromUser, fromClient, rooms }) {
    if (thisStartsWithOneOfThese(NPCObj.inRoom, rooms)) {
        let route;
        ...
        io.to(fromClient.username).emit('error', { err: `Looks like ${NPCObj.primaryName} is in a different room` });
    }
}